...
let songs = [
    './New folder (5)/music/Big City Boi-Binz_Touliver.mp3',
    './New folder (5)/music/Co Chac Yeu La Day-M-Tp.mp3'
]
let covers = [
    './New folder (5)/img/binz.jpg ',
    './New folder (5)/img/co chac yeu la day.jpg '
]
let playing = true
function playPause() {
    if (playing) {
        pPause.src='./New folder (5)/New folder (4)/icons8-pause-30.png '
        song.play()
    } else {
        pPause.src='./New folder (5)/New folder (4)/icons8-play-button-circled-48.png'
        song.pause()
    }
    playing = !playing
}
